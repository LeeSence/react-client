    ...
    <Card className="border">
      <CardHeader className="flex-sm-row flex-column justify-content-sm-between justify-content-center align-items-sm-center align-items-start">
        <CardTitle className="d-flex align-items-center">
          ...
          >
            <FontAwesomeIcon icon={faGaugeSimpleHigh} size="2x" />
          </Button.Ripple>
          <span className="fs-2">Speed</span>
        </CardTitle>
      </CardHeader>
        ...
        <div className="d-flex align-items-center mb-2">
          <div className="me-2">
            <span
              ...
              style={{ backgroundColor: "rgba(65, 250, 100, .5)" }}
            ></span>
          ...
          <div>
            <span
              className="bullet bullet-sm bullet-bordered me-50"
              style={{ backgroundColor: "rgba(65, 250, 100, .2)" }}
            ></span>
          ...
          <ResponsiveContainer className="h-50">
            <AreaChart height={400} data={data}>
              ...
              <Area
                ...
                stackId="Average"
                stroke="0"
                fill="rgba(65, 250, 100, .5)"
              />
              <Area
                dataKey="Max"
                stackId="Max"
                stroke="0"
                fill="rgba(65, 250, 100, .2)"
              />
            </AreaChart>
          </ResponsiveContainer>
        </div>

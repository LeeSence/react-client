    ...
    <Card className="border">
      <CardHeader className="flex-sm-row flex-column justify-content-sm-between justify-content-center align-items-sm-center align-items-start">
        <CardTitle className="d-flex align-items-center">
          ...
          <span className="fs-2">Heartrate</span>
        </CardTitle>
      </CardHeader>
        ...
        <div className="d-flex align-items-center mb-2">
          <div className="me-2">
            <span
              ...
              style={{ backgroundColor: "rgba(250, 30, 30, .5)" }}
            ></span>
          ...
          <div>
            <span
              className="bullet bullet-sm bullet-bordered me-50"
              style={{ backgroundColor: "rgba(250, 30, 30, .2)" }}
            ></span>
          ...
          <ResponsiveContainer className="h-50">
            <AreaChart height={400} data={data}>
              ...
              <Area
                ...
                stackId="Average"
                stroke="0"
                fill="rgba(250, 30, 30, .5)"
              />
              <Area
                dataKey="Max"
                stackId="Max"
                stroke="0"
                fill="rgba(250, 30, 30, .2)"
              />
            </AreaChart>
          </ResponsiveContainer>
        </div>
